 ...
 *   https://datatables.net/download/#bs4/dt-1.11.3/b-2.1.1/b-html5-2.1.1/date-1.1.1
 *
 * Included libraries:
 *   DataTables 1.11.3, Buttons 2.1.1, HTML5 export 2.1.1, DateTime 1.1.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.11.3/b-2.1.1/b-html5-2.1.1/date-1.1.1",
