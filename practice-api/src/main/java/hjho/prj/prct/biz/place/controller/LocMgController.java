...
public class LocMgController extends CommonController {
	...
	@GetMapping()
	@ApiOperation(value="getLoc", notes="지역 조회", response=LocMgPagingRVO.class)
	...
	@PostMapping()
	@ApiOperation(value="postLoc", notes="지역 등록", response=Integer.class)
	...
	@PutMapping()
	@ApiOperation(value="putLoc", notes="지역 수정", response=Integer.class)
	...
	@DeleteMapping()
	@ApiOperation(value="deleteLoc", notes="지역 삭제", response=Integer.class)
