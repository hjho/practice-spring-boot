...
import hjho.prj.prct.biz.system.model.MgrEmpMgVO;
import hjho.prj.prct.biz.system.service.MgrEmpMgService;
...
public class MgrEmpMgController extends CommonController {
	...
	public CommonMessage getMgrEmp(@ModelAttribute MgrEmpMgPagingPVO mgrDeEmpMgPagingPVO) {
		this.parameterLog("MgrEmpMg[getMgrEmp]", mgrDeEmpMgPagingPVO);
		
		CommonMessage output = new CommonMessage();
		
		List<MgrEmpMgPagingRVO> listMgrEmp = mgrEmpMgService.getMgrEmp(mgrDeEmpMgPagingPVO);
